...
exercises = [
    ...
    Exercise(
        ...
        seconds=None,
        notes=None,
        exercise_type_id="8278d21c-1ffa-4dbf-b5b0-070cdb7824cd",
        workout_id="a8d26bbc-c6af-4d85-b019-82096b1a21af",
        user_id="ddf909e8-1ef9-4cdc-8476-732137a352d8",
    ),
    Exercise(
        id="14b11dc1-c14f-4768-8d97-98a33a613c01",
    ...
    Exercise(
        id="777a333b-9461-4ea4-9543-f548af86c02a",
        ...
        seconds=None,
        notes=None,
        exercise_type_id="5d4d6ef0-5e14-4506-8525-87d3b1903568",
        workout_id="a8d26bbc-c6af-4d85-b019-82096b1a21af",
        user_id="ddf909e8-1ef9-4cdc-8476-732137a352d8",
    ),
    Exercise(
        id="a9228bd9-aa6b-474e-b78a-5cceb5cfa14c",
