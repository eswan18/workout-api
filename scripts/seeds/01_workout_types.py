...
workout_types = [
    ...
    WorkoutType(
        id="3d531b3b-907f-488b-b2b6-ad3e541d08fd",
        name="Upper Body",
    ...
    WorkoutType(
        id="72c29956-f71a-4e6a-b8e2-d6ea2008ed35",
        name="Pull Day",
    ...
    WorkoutType(
        id="a4f69cd3-12ba-42ec-8ffc-b03a167f489e",
        name="Push Day",
    ...
    WorkoutType(
        id="463b07e1-4185-4a8f-8b59-71192dc141c4",
