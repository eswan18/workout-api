...
exercise_types = [
    ...
    ExerciseType(
        id=UUID("8278d21c-1ffa-4dbf-b5b0-070cdb7824cd"),
        name="Bicep Curls",
        number_of_weights=2,
        notes=None,
        owner_user_id=None,
    ...
    ExerciseType(
        id=UUID("5d4d6ef0-5e14-4506-8525-87d3b1903568"),
        name="Seated rows",
        number_of_weights=1,
        notes="(machine)",
        owner_user_id=None,
    ...
    ExerciseType(
        id=UUID("1624bfc4-e191-49c7-8173-118058570ac0"),
        name="Barbell Squats",
        number_of_weights=1,
    ...
    ExerciseType(
        id=UUID("bef96a30-3dd5-4c94-abbb-e822301e7083"),
        name="Planks",
        number_of_weights=0,
    ...
    ExerciseType(
        id=UUID("feb588b5-e86b-4269-8121-475682df2830"),
